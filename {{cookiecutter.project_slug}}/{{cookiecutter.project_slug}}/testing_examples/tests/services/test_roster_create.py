...
from {{cookiecutter.project_slug}}.testing_examples.models import Roster
from {{cookiecutter.project_slug}}.testing_examples.services import (
...
class RosterCreateTests(TestCase):
    ...
    @patch("{{cookiecutter.project_slug}}.testing_examples.services.rosters.roster_validate_period")
