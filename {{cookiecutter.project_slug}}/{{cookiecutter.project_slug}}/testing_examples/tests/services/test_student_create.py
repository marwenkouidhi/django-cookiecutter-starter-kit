...
from {{cookiecutter.project_slug}}.testing_examples.services import student_create
from {{cookiecutter.project_slug}}.testing_examples.tests.factories import (
    SchoolCourseFactory,
    SchoolFactory,
)
...
class StudentCreateTests(TestCase):
    @patch("{{cookiecutter.project_slug}}.testing_examples.services.students.school_list_school_courses")
    @patch("{{cookiecutter.project_slug}}.testing_examples.services.students.roster_create")
